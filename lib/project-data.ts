...
export const projects: Project[] = [
  ...
  },
  {
    ...
    index: "05",
    title: "益电工 · 政企知识服务平台",
    category: "政企服务 / 知识资产 / 多角色权限",
    timeframe: "早期项目",
    role: "高级产品体验主管",
    summary: "围绕国家电网 e 电工等政企项目，建立多角色、多端一致的知识服务与标准化交付体系。",
    ...
    approach: [
      { title: "角色与权限地图", body: "从业务流程出发定义不同角色的目标、信息权限与关键动作。" },
      { title: "知识资产结构化", body: "把项目经验、交付规则和高频问题沉淀为可复用内容。" },
      { title: "多端一致性", body: "统一核心任务与信息层级，减少不同终端之间的认知切换。" },
      { title: "标准化交付", body: "通过 SOP、评审标准和团队协同机制提升复杂项目交付质量。" },
    ],
    decisions: [
