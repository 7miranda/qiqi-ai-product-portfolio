...
export const projects: Project[] = [
  {
    ...
    metric: "2–3 → 10–20",
    metricLabel: "零基础学员稳定日产",
    metricUnit: "条 / 日",
    metricExplanation: "从接到选题到输出成片，日产由 2–3 条提升到 10–20 条",
  ...
  },
  {
    ...
    metricUnit: "元",
    metricExplanation: "单一 Agent 累计销售额；单日峰值 20 万元，单月峰值 100 万元+",
    shortProof: "单体累计销售 600 万+",
    accent: "#111310",
  ...
  },
  {
    ...
    metricLabel: "工具调用准确率",
    metricUnit: "",
    metricExplanation: "基于 200 条真实样本回归，工具调用准确率由 71% 提升到 89%",
    ...
    approach: [
      ...
      { title: "业务心智工具层", body: "将 API 描述从后端语言改写为客户经理的任务语言，提升工具选择准确率。" },
  ...
  },
  {
    ...
    timeframe: "早期项目",
    role: "高级产品体验主管",
    summary: "串联 C 端下单、电工技术支持、客服订单处理与同方向网课学习，建立服务和培训一体化的业务承接系统。",
    thesis: "服务平台的效率，不来自更多入口，而来自订单、履约与知识支持的闭环。",
    metric: "+28%",
    metricLabel: "商家成单率提升",
    metricUnit: "",
    metricExplanation: "打通 C 端下单、客服订单处理、电工技术支持与网校协同后，成单率提升 28%",
    shortProof: "成单率提升 28%",
    accent: "#111310",
    ...
    approach: [
      { title: "C 端订单承接", body: "从选服务、提交需求、预约到进度反馈，建立用户可理解的完整下单路径。" },
      { title: "客服订单中台", body: "统一订单分派、状态推进、异常升级与用户沟通，减少跨角色信息断点。" },
      { title: "电工技术支持", body: "将后台专家经验、高频故障和交付规则沉淀为可查询、可复用的技术知识。" },
      { title: "网校学习系统", body: "把同方向网课、学习进度与服务场景关联，让培训内容能够反哺实际履约。" },
    ],
    decisions: [
