...
export interface AnimatedListProps {
  ...
  /** Additional class applied to every item shell */
  itemClassName?: string;
  /** Additional class applied to every item content wrapper */
  contentClassName?: string;
  /** Animate the initial item set on mount */
  animateInitial?: boolean;
  /** Delay in seconds between initial item entrances */
            ...
            {items.map((item, index) => {
              return (
                <motion.li
                  ...
                  transition={{
                    ...getTransition(),
                    delay: animateInitial ? index * initialStagger : 0,
                  }}
                  style={{
                    overflow: "visible",
